...
@section('bottomHead')
    <script>
        ...
        document.getElementById('districts').classList.add('active');
    </script>
    <script type="text/javascript" src="/manage/js/core/districtController.js"></script>
@endsection
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <select class="form-control selectpicker" name="state" id="state" data-live-search="true"
                                                    onchange="getCitiesDistrict(this.value,  document.getElementById('token').value, '#city')">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <input type="text" id="districtId" name="districtId" style="display: none">
                                        </div>
                                        @error('name')
                                        <span class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i>{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="content-group">
                                            <label> </label>
                                            <?php if($accessList['insert_8'] == "on") { ?>
                                                <div>
                                                    <button type="submit" id="save" style="display: block; width: 100%" class="btn btn-primary" onclick="$('#startSpinner').click();">ثبت</button>
                                                </div>
                                            <?php } if($accessList['update_8'] == "on") { ?>
                                                <div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="update" style="display: none; width: 100%" class="btn btn-primary" onclick="updateDistrict(true, '#districtId', '#state', '#city', '#name', document.getElementById('token').value)">ویرایش</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="cancel" style="display: none; width: 100%" class="btn btn-danger" onclick="updateDistrict(false, '#districtId', '#state', '#city', '#name', document.getElementById('token').value)">لغو</button>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 col-sm-4">
                                            <div>
                                                ...
                                                <select class="form-control selectpicker" name="searchState" id="searchState" data-live-search="true"
                                                        onchange="getCitiesDistrict(this.value,  document.getElementById('token').value, '#searchCity')">
                                                    <option value="">انتخاب کنید</option>
                                                    @foreach($states as $state)
                                                        <option value="{{ $state->id }}">{{ $state->title }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-4">
                                            <div>
                                                <label>شهر</label>
                                                <select class="form-control selectpicker" name="searchCity" id="searchCity" data-live-search="true">
                                                    <option value="">انتخاب کنید</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th>محله <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>
                                                <?php if($accessList['update_8'] == "on") { ?>
                                                <th>ویرایش <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>
                                                <?php } if($accessList['delete_8'] == "on") { ?>
                                                <th>حذف</th>
                                                <?php } ?>
                                            </tr>
                                            </thead>
