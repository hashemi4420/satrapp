...
@section('bottomHead')
    <script>
        ...
        document.getElementById('articleGroups').classList.add('active');
    </script>
    <script type="text/javascript" src="/manage/js/core/articleGroupController.js"></script>
@endsection
                        ...
                        <form class="form-horizontal" method="post" id="form">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            <label>نام گروه کالا</label>
                                            <input type="text" class="form-control" name="nameId" id="nameId">
                                            <input type="text" id="groupId" name="groupId" style="display: none">
                                        </div>
                                        @error('nameId')
                                        <span class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i>{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="content-group">
                                            <label> </label>
                                            <?php if ($accessList['insert_11'] == "on"){?>
                                                <div>
                                                    <button type="submit" id="save" style="display: block; width: 100%" class="btn btn-primary" onclick="$('#startSpinner').click();">ثبت</button>
                                                </div>
                                            <?php } if ($accessList['update_11'] == "on"){?>
                                                <div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="update" style="display: none; width: 100%" class="btn btn-primary" onclick="updateArticleGroup(true, '#groupId', '#areaId', '#nameId', document.getElementById('token').value)">ویرایش</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="cancel" style="display: none; width: 100%" class="btn btn-danger" onclick="updateArticleGroup(false, '#groupId', '#areaId', '#nameId', document.getElementById('token').value)">لغو</button>
                                                    </div>
                                                </div>
                                            <?php }?>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <?php } if ($accessList['delete_11'] == "on"){?>
                                                <th>حذف</th>
                                                <?php }?>
                                            </tr>
                                            </thead>
