...
@section('bottomHead')
    <script>
        ...
        document.getElementById('serviceProvider').classList.add('active');
    </script>
    <script type="text/javascript" src="/manage/js/core/serviceProviderController.js"></script>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <select class="form-control selectpicker" name="area" id="area" data-live-search="true"
                                                    onchange="getServiceGroupProvider(this.value,  document.getElementById('token').value, '#group')">
                                                <option value="">انتخاب کنید</option>
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <select class="form-control selectpicker" name="group" id="group" data-live-search="true"
                                                    onchange="getServiceCategoryProvider(this.value,  document.getElementById('token').value, '#category')">
                                                <option value="">انتخاب کنید</option>
                                            </select>
                                        </div>
                                        @error('group')
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <select class="form-control selectpicker" name="category" id="category" data-live-search="true"
                                                    onchange="getServiceProvider(document.getElementById('brand').value,
                                                                                    document.getElementById('area').value,
                                                                                    document.getElementById('group').value,
                                                                                    this.value,  document.getElementById('token').value, '#serviceId'
                                                    )">
                                                <option value="">انتخاب کنید</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div>
                                            ...
                                            <select class="form-control selectpicker" name="service" id="serviceId" data-live-search="true">
                                                <option value="">انتخاب کنید</option>
                                            </select>
                                        </div>
                                        @error('service')
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="content-group">
                                            <label> </label>
                                            <?php if ($accessList['insert_21'] == "on"){ ?>
                                                <div>
                                            ...
                                            <?php } if ($accessList['update_21'] == "on"){ ?>
                                                <div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="update" style="display: none; width: 100%; margin-top: 55px" class="btn btn-primary" onclick="updateServiceProvider(true, '#providerId', '#serviceId', '#price', '#status', document.getElementById('token').value)">ویرایش</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="cancel" style="display: none; width: 100%; margin-top: 55px" class="btn btn-danger" onclick="updateServiceProvider(false, '#providerId', '#serviceId', '#price', '#status', document.getElementById('token').value)">لغو</button>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-4">
                                            <div>
                                                ...
                                                <select class="form-control selectpicker" name="searchCategory" id="searchCategory" data-live-search="true"
                                                        onchange="getServiceProvider(document.getElementById('searchBrand').value,
                                                                                    document.getElementById('searchArea').value,
                                                                                    document.getElementById('searchGroup').value,
                                                                                    this.value,  document.getElementById('token').value, '#searchService'
                                                    )">
                                                    <option value="">انتخاب کنید</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-4">
                                            <div>
                                                <label>نام خدمات</label>
                                                <select class="form-control selectpicker" name="searchService" id="searchService" data-live-search="true">
                                                    <option value="">انتخاب کنید</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th>قیمت <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>
                                            ...
                                            @foreach($providers as $provider)
                                                <tr>
                                                    ...
                                                    <td><div class="list-unstyled row clearfix aniimated-thumbnials">
                                                            <a href="{{$provider->service->url_avatar}}" data-sub-html="{{$provider->service->service->title}}">
                                                                <img class="img-responsive thumbnail" src="{{$provider->service->url_avatar}}" alt="{{$provider->service->service->title}}" width="35">
                                                            </a>
                                                        </div>
                                                    <td>{{$provider->service->service->title}}</td>
                                                    <td>{{$provider->service->brand->title}}</td>
                                                    <td>{{$provider->service->area->title}}</td>
                                                    <td>{{$provider->service->group->title}}</td>
                                                    <td>{{$provider->service->category->title}}</td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-icon btn-rounded"
                                                                onclick="startUpdateServiceProvider({{$provider->id}}, document.getElementById('token').value, '#providerId', '#brand', '#area', '#group', '#category', '#serviceId', '#price', '#status')">
                                                    ...
                                                    @if($provider->active)
                                                        <td id="{{$provider->id}}">
                                                            <button type="button" class="btn btn-success btn-icon btn-rounded"
                                                                    onclick="activeServiceProvider({{$provider->id}}, document.getElementById('token').value)">
