...
@section('bottomHead')
    <script>
        ...
        document.getElementById('articleAreas').classList.add('active');
    </script>
    <script type="text/javascript" src="/manage/js/core/articleAreaController.js"></script>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="content-group">
                                            <label> </label>
                                            <?php if($accessList['insert_10'] == "on"){?>
                                                <div>
                                                    <button type="submit" id="save" style="display: block; width: 100%" class="btn btn-primary" onclick="$('#startSpinner').click();">ثبت</button>
                                                </div>
                                            <?php } if($accessList['update_10'] == "on"){?>
                                                <div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="update" style="display: none; width: 100%" class="btn btn-primary" onclick="updateArticleArea(true, '#areaId', '#name', document.getElementById('token').value)">ویرایش</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <button type="button" id="cancel" style="display: none; width: 100%" class="btn btn-danger" onclick="updateArticleArea(false, '#areaId', '#name', document.getElementById('token').value)">لغو</button>
                                                    </div>
                                                </div>
                                            <?php }?>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <?php }if ($accessList['delete_10'] == "on"){?>
                                                <th>حذف</th>
                                                <?php }?>
                                            </tr>
                                            </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    @if($area->active)
                                                        <td id="{{$area->id}}">
                                                            <button type="button" class="btn btn-success btn-icon btn-rounded"
                                                                    onclick="activeArticle({{$area->id}}, document.getElementById('token').value)">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-icon btn-rounded"
                                                                onclick="startUpdateArticleArea({{$area->id}}, document.getElementById('token').value, '#areaId', '#name')">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-icon btn-rounded"
                                                                onclick="deleteArticleArea({{$area->id}}, document.getElementById('token').value)">
