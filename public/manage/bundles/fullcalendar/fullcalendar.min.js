    ...
    return function (t) {
        ...
        var i = n(2), r = n(4), o = n(14), s = function (t) {
            ...
            return i.__extends(e, t), e.prototype.updateDayTable = function () {
                ...
                }, i) : i) + " <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>"
        ...
        function i(t) {
            return function (t) {
                ...
                return r.__extends(e, t), e.prototype.renderHeadIntroHtml = function () {
                    var t = this.view;
                    return this.colWeekNumbersVisible ? '<th class="fc-week-number ' + t.calendar.theme.getClass("widgetHeader") + '" ' + t.weekNumberStyleAttr() + "><span>" + s.htmlEscape(this.opt("weekNumberTitle")) + "</span> <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>" : ""
                }, e.prototype.renderNumberIntroHtml = function (t) {
        ...
        function i(t) {
            return function (t) {
                ...
                return s.__extends(e, t), e.prototype.renderHeadIntroHtml = function () {
                    ...
                    }, u.htmlEscape(t)) + " <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>") : '<th class="fc-axis ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + "> <i style="color: #09d26e;" class="fas fa-arrow-left"></i></th>"
                }, e.prototype.renderBgIntroHtml = function () {
                    var t = this.view;
