...
var calendar = $('#myEvent').fullCalendar({
  ...
  events: [{
    ...
    end: new Date(year, month, day, 12, 10),
    backgroundColor: "#00bcd4"
  }, {
    title: "نیلوفر",
    start: new Date(year, month, day, 13, 30),
    end: new Date(year, month, day, 14, 10),
